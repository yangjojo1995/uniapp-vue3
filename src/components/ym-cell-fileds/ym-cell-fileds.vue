...
const handleClick = (event: any) => {
  uni.$once("features-page/select-fileds:fileds", (data) => {
    list.value = data;
    emit("update:modelValue", list.value);
  });
  console.log(list.value);
  uni.navigateTo({
    url: "/pages/features-page/select-fileds?value=" + list.value,
  });
};

// ====================================

let filedsModal = ref(false);
...
onMounted(() => {
  getDictionaryFileds("invest_field");
});
</script>
