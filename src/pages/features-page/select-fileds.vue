<template>
   <view class="fileds-wrap">
      <ym-easytag-select-panel title="投资领域" limit="10" v-model="list" :options="options"></ym-easytag-select-panel>
...
const submit = () => {
  ...
  console.log(list)
  uni.$emit('features-page/select-fileds:fileds', list)
  uni.navigateBack({
    delta:1
  })
}
...
onLoad (async (options:any) => {
  await getDictionaryFileds('invest_field')
