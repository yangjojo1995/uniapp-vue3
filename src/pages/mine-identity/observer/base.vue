  ...
  <view class="wrap my-base-card">
    <view class="action-list u-p-x-26 bg-white u-m-b-20">
      ...
      <view class="required action-item flex ai-center jc-between u-p-y-48 fs-28">
        ...
        <u-input maxlength="50" class="action-value text-color-third u-p-r-30" trim="true" input-align="right" v-model="params.fullName" border="false" placeholder="请输入"></u-input>
      </view>
      <view class="required action-item flex ai-center jc-between u-p-y-48 fs-28">
      ...
      <view class="action-item flex ai-center jc-between u-p-y-48 fs-28">
        ...
        <u-input maxlength="18" class="action-value text-color-third u-p-r-30" trim="true" input-align="right" v-model="params.creditCode" border="false" placeholder="请输入"></u-input>
      </view>
      ...
      <ym-cell-industy :padding="false" :border="false" :required="false" :create="true" align="right" label="所属行业" v-model="params.belongIndustry" forward />
    </view>
...
const submit = async () => {
  ...
  try {
    ...
    const result = await service.certification.addObserverDraft(paramsCopy);
    setTimeout(() => {
      uni.hideLoading();
      isSubmit = false;
      uni.navigateBack({
