  ...
  <view class="page">
    ...
    <view class="header" :class="{'enable-state': data.enable === 1}">
      ...
      <block v-if="data.enable === 0">
        <view class="header__desc">
          <view class="flex ai-center jc-center" @click="router.push({ path: '/pages/observer/credibility', query: { id: data.id } })">
    ...
    <block v-if="data.enable === 0">
      <ym-group title="基本信息" type="info">
        <view class="field">
          <view class="field__label">单位全称</view>
        ...
        <view class="field">
          ...
          <view class="field__value">
            <text v-if="data.belongProvinceStr">{{ data.belongProvinceStr }}{{ data.belongCityStr }}{{ data.belongDistrictStr }}</text>
